function result = getResultFromCsv(file, numberValid)

if nargin < 2
    numberValid = [];
end

if isempty(numberValid)
    numberValid = -1;
end
...
if numberOfResults == 0
    ...
    if numberValid == -1
        ...
        if numberValid > numberOfResults
            error('s');
        end
        beginid = numberOfResults - numberValid + 1;
    end
    
    ids = beginid : numberOfResults;
    ...
    r.peakT = r.peakT / nvalid;
    r.avrgT = r.avrgT / nvalid;
    r.peakt = r.peakt / nvalid;
    r.avrgt = r.avrgt / nvalid;
    r.cpuUsage = r.cpuUsage / nvalid;
    r.missDeadlines = [];
    result = r;
