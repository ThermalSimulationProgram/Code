...
/* Stress test classes */
typedef struct {
	uint32_t class_name;			/* Class type bit mask */
...
typedef struct {
	const stress_func stressFunc;	/* stress test function */
	...
	const uint32_t class_name;		/* class of stress test */
} stress_t;
...
extern void set_iopriority(const int32_t class_name, const int32_t level);
